...
SkittyCurmudgeon = function() {
    ...
    self.generateInsult = function(data) {
        var wordBank = SkittyResource.call( 'curmudgeon', 'insultGenerator'),
        ...
        var msg = SkittyResource.call( 'curmudgeon', 'insultGenerator').madlib.replace('{user}', name).replace('{a}', a).replace('{b}', b).replace('{c}', c).replace('{d}', d).replace('{e}', e).replace('{f}', f);
    ...
    var chatCommands = [{
        ...
        action: function(data) {
            core.showMessage(SkittyResource.call( 'curmudgeon', 'generic'));
        }
    }, {
        trigger: 'do your best!',
        wildCard: true,
        action: this.generateInsult
    }, {
        trigger: 'fuck you s\'kitty',
        wildCard: true,
        action: function(data) {
            core.showMessage(SkittyResource.call( 'curmudgeon', 'fuckYou'), data);
        }
    }, {
        trigger: 'fuck you skitty',
        wildCard: true,
        action: function(data) {
            core.showMessage(SkittyResource.call( 'curmudgeon', 'fuckYou'), data);
        }
        ...
        wildCard: true,
        action: function(data) {
            core.showMessage(SkittyResource.call( 'curmudgeon', 'whoa'));
        }
    }, {
        trigger: 'whoa',
        wildCard: true,
        ...
        wildCard: true,
        action: function(data) {
            core.showMessage(SkittyResource.call( 'curmudgeon', 'exactly'));
        }
    }, {
        trigger: 'erm',
        action: this.ermify
